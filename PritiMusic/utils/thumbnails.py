...
# This file is part of PritiMusicMusic
#ALONE-CODER
...
from PritiMusic import config
from PritiMusic.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("PritiMusic/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("PritiMusic/helpers/Inter-Light.ttf", 30)
